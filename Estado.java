...
public class Estado {
    ...
    public static void main (String []args){
        ...
        sigla = entrada.next();
        entrada.close();
        //solicitamos a entrada de uma sigla de uma UF ao usuário 

        switch(sigla){
            //O usuário pode inserir uma das 5 siglas, sendo em letras maiúsculas ou minúsculas
            case "PR":
            case "pr":
            ...
            break;
                ...
                break;
                    ...
                    break;
                        ...
                        //Se a sigla não existir, informa inválida
